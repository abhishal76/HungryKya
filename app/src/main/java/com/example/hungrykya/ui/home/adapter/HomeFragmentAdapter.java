package com.example.hungrykya.ui.home.adapter;
...
public class HomeFragmentAdapter extends ArrayAdapter<Restaurant> {
    ArrayList<Restaurant> restaurantArrayList;
    Context context;
    int res;
    public HomeFragmentAdapter(@NonNull Context context, int resource,  ArrayList<Restaurant> restaurantArrayList) {
